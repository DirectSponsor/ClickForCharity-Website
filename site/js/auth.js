...
window.updateLoginUI = () => {
    ...
    if (isLoggedIn && session) {
        ...
        const fullUsernameDisplay = document.getElementById('full-username-display');
        if (fullUsernameDisplay) {
            fullUsernameDisplay.textContent = session.combined_user_id || session.username;
        }
    } else {
        // Show login button
