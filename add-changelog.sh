...
# Example: ./add-changelog.sh "Feature" "Donations page now shows real-time totals."

SITE_NAME="ClickForCharity"
CHANGELOG="site/changelog.html"

if [ "$#" -ne 2 ]; then
    echo "Usage: $0 \"Category\" \"Description\""
    echo "Example: $0 \"Feature\" \"Donations page now shows real-time totals.\""
    exit 1
fi
